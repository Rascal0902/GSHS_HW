...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mID = (EditText) findViewById(R.id.editText);
        mPassword = (EditText) findViewById(R.id.editText2);

        // Button
        mIdSignInButton = (Button) findViewById(R.id.button); // sign in button
        mIdSignUpButton = (Button) findViewById(R.id.button2); // sign up button
